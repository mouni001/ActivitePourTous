...
const Main = () => {
    ...
    <a button type="button" class="btn btn-light" href="./Reservation">Réservez votre place</a>
  </div>
  <div class="container">
    <div class="but">
    <h1>But de l'Entreprise</h1>
    <h4>Activités pour tous offre des activités et des ateliers communautaires<span className="navbar-brand"> gratuits</span>pour les gens de 
     <span className="navbar-brand"> différentes tranches d’âge</span></h4>
    </div>
  </div>
  <div class="container">
    <h2> Trouvez une ativités selon votre groupe d'âge!</h2>
      ...
      <div className="mydivcontainer">
        ...
        <img src={enfants} alt="Enfants" className="image"/>
        <div class="overlay">
          <div class="text">Enfants</div>
          <div class="savoir"><p href="/Activité">En savoir plus</p></div>
        </div>
      </div>
      </div>
      <div className="mydiv"> 
        <div class="container2">
        <img src={personne} alt="Enfants" className="image"/>
        <div class="overlay">
      ...
      <div className="mydiv"> 
        <div class="container2">
        <img src={Famille} alt="Enfants" className="image"/>
        <div class="overlay">
      ...
      <div className="mydiv"> 
        <div class="container2">
        <img src={femmes} alt="Enfants" className="image"/>
        <div class="overlay">
      ...
      <div className="mydiv"> 
        <div class="container2">
        <img src={homme} alt="Enfants" className="image"/>
        <div class="overlay">
      ...
      <div className="mydiv"> 
        <div class="container2">
        <img src={ado} alt="Enfants" className="image"/>
        <div class="overlay">
