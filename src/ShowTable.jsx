  ...
  return (
      <div>
        <div className='containerbutton2'>
            <p>Vous pouvez filtrer selon le groupe d'âge rechercher</p>
          ...
          <button type="button" class="btn btn-dark" onClick={reviewsHandler}>
              Femmes</button>
          <button  type="button" class="btn btn-dark" onClick={PersonneHandler}>
              Ainés</button>
          <button type="button" class="btn btn-dark" onClick={FamilleHandler}>
              Famille</button>
          <button type="button" class="btn btn-dark" onClick={HommesHandler}>
              Hommes</button>
          <button type="button" class="btn btn-dark" onClick={AdoHandler}>
              Adolescent</button>
        <button type="button" class="btn btn-dark" onClick={EnfantHandler}>
              Enfants</button>
              </div>
          {Tous && (
              <p>
        ...
        <div className="mydiv2"><img src={poterie} alt="personne" className="img2"/>
          ...
          <a type="button" class="btn btn-light" href="./Reservation">Réservez votre place</a>
          <a type="button" class="btn btn-light" href="./Commentaire">Laissez nous votre commentaire</a>
        </div>
